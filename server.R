...
server <- function(input, output, session) {
  ...
  observeEvent(input$single_file, {
    ...
    output$single_loaded_data <- renderDataTable(single_index_df())
  })
  ...
  observeEvent(
    input$single_search, {
      ...
      if (is.null(input$single_file)){
        ...
        log_text = paste(log_text, "Platform: ", input$single_platform, "\n", sep="")
  ...
  observeEvent(input$dual_file1, {
    ...
    output$dual_loaded_data1 <- renderDataTable(dual_index_df1())
  ...
  observeEvent(input$dual_file2, {
    ...
    output$dual_loaded_data2 <- renderDataTable(dual_index_df2())
  ...
  observeEvent(
    input$dual_search, {
      ...
      if (is.null(input$dual_file1) || is.null(input$dual_file2)){
        ...
        log_text = paste(log_text, "Platform: ", input$dual_platform, "\n", sep="")
